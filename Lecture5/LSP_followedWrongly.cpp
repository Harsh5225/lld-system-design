...
public:
  ...
  void processTransactions()
  {
    for (Account *acc : accounts)
    {
      ...
      //       typeid is an operator in C++ used to get the type information of a variable or object at runtime.

      // It returns a reference to a type_info object, which represents the type of the expression.
